...
import type {Account, CreateAccount, PreferenceEntry} from "~/shared/domain/Account.model";
...
export interface AccountRepository {
    ...
    findPreferencesByUuid(uuid: string, category?: string, key?: string): Promise<PreferenceEntry[] | undefined>;
    updatePreference(accountUuid: string, category: string, key: string, value: string): Promise<void>;
}
